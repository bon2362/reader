...
- [ ] Task 1: Создать `AnnotationExportService`
  - [ ] 1.1 Загрузка всех книг библиотеки
  - [ ] 1.2 Загрузка аннотаций книги
  - [ ] 1.3 Преобразование в exchange-document
  - [ ] 1.4 Передача в `MarkdownAnnotationEncoder`

- [ ] Task 2: Реализовать file output flow
  - [ ] 2.1 Определить naming rule для файлов
  - [ ] 2.2 Обработать slug/file-safe title
  - [ ] 2.3 Записать `.md` на диск

- [ ] Task 3: Зафиксировать поведение для книг без аннотаций
  - [ ] 3.1 Либо пропускать
  - [ ] 3.2 Либо экспортировать пустой файл по контракту

- [ ] Task 4: Реализовать summary/report
  - [ ] 4.1 exported count
  - [ ] 4.2 skipped count
  - [ ] 4.3 failed count

- [ ] Task 5: Написать integration tests
  - [ ] 5.1 Экспорт нескольких книг
  - [ ] 5.2 Ошибка одной книги не валит пакет
  - [ ] 5.3 Книга без аннотаций обрабатывается по выбранному правилу
...
- Reader/** export service files as needed
- ReaderTests/* export integration tests
